...
[@walletmesh/modal-core](../../../modules.md) / [@walletmesh/modal-core](../README.md) / RESPONDER\_FEATURES
...
> `readonly` **ACCOUNT\_MANAGEMENT**: `"account-management"`
...
> `readonly` **BATCH\_TRANSACTIONS**: `"batch-transactions"`
...
> `readonly` **CROSS\_CHAIN\_SWAPS**: `"cross-chain-swaps"`
...
> `readonly` **DEFI\_INTEGRATION**: `"defi-integration"`
...
> `readonly` **GASLESS\_TRANSACTIONS**: `"gasless-transactions"`
...
> `readonly` **HARDWARE\_ACCELERATION**: `"hardware-acceleration"`
...
> `readonly` **HARDWARE\_WALLET**: `"hardware-wallet"`
...
> `readonly` **MESSAGE\_SIGNING**: `"message-signing"`
...
> `readonly` **MULTI\_SIGNATURE**: `"multi-signature"`
...
> `readonly` **NFT\_SUPPORT**: `"nft-support"`
...
> `readonly` **PRIVATE\_TRANSACTIONS**: `"private-transactions"`
...
> `readonly` **SOCIAL\_RECOVERY**: `"social-recovery"`
...
> `readonly` **TRANSACTION\_SIGNING**: `"transaction-signing"`
