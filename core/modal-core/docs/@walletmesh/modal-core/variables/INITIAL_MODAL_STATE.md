...
[@walletmesh/modal-core](../../../modules.md) / [@walletmesh/modal-core](../README.md) / INITIAL\_MODAL\_STATE

# Variable: INITIAL\_MODAL\_STATE

> `const` **INITIAL\_MODAL\_STATE**: [`ModalState`](../type-aliases/ModalState.md)
