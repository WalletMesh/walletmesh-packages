...
- [DiscoveryEventWrapper](classes/DiscoveryEventWrapper.md)
...
- [InternalWalletMeshClient](interfaces/InternalWalletMeshClient.md)
...
- [DiscoveryProtocolEvent](type-aliases/DiscoveryProtocolEvent.md)
