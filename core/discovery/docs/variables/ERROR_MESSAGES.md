...
[@walletmesh/discovery](../globals.md) / ERROR\_MESSAGES

# Variable: ERROR\_MESSAGES

> `const` `readonly` **ERROR\_MESSAGES**: `Record`\<`number`, `string`\>

Defined in: [core/discovery/src/core/constants.ts:465](https://github.com/WalletMesh/walletmesh-packages/blob/12c69c80bd306fd0702c0580f12668e94970ec0a/core/discovery/src/core/constants.ts#L465)
