import { WalletMeshConfig, ConnectorType } from '@walletmesh/modal';
...
export const sandboxConfig = WalletMeshConfig.create()
  ...
  .setDappInfo({
    name: 'Example DApp (Dev)',
    description: 'Local development environment for testing wallet connections',
