...
export const WalletList: WalletInfo[] = [
  {
    id: 'turnstile',
    name: 'Turnstile Wallet',
    iconDataUri:
      "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24'><circle cx='12' cy='12' r='10' fill='%23FF9900'/></svg>",
    connector: {
  ...
  },
  {
    ...
    websiteUrl: 'https://obsidion.vercel.app/sign',
    connector: {
  ...
  },
  {
    ...
    name: 'AzGuard Wallet',
    iconDataUri:
      "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24'><path d='M12 0 L24 24 L0 24 Z' fill='%2320E3B2'/></svg>",
    connector: {
      type: ConnectorType.FakeAztec,
    },
  },
