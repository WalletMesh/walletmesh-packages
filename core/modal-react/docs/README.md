...
- [TypeScript Examples](_media/TYPESCRIPT_EXAMPLES.md) - Comprehensive TypeScript usage examples
- [Error Recovery Patterns](_media/ERROR_RECOVERY_PATTERNS.md) - Production-ready error handling patterns
- [Provider Pattern Guide](_media/PROVIDER_PATTERN_GUIDE.md) - Public/private provider pattern documentation
- [Aztec Developer Guide](_media/AZTEC_DEVELOPER_GUIDE.md) - Complete guide for Aztec dApp development
- [Migration Guide](_media/MIGRATION_GUIDE.md) - Migrate from direct Aztec SDK to WalletMesh
...
See the [Provider Pattern Guide](_media/PROVIDER_PATTERN_GUIDE.md) for more details on the public/private provider pattern.
